                ...
                <td>
                  <div className="icons-container">
                    <div onClick={() => updateUser(user._id)}>
                      <FaEdit className="action-icon" id="edit" />
                    </div>
                    <div onClick={() => deleteUser(user._id)}>
                      <AiFillDelete className="action-icon" id="delete" />
                    </div>
                    <div onClick={() => userDetails(user._id)}>
                      <AiOutlineEye className="action-icon" id="eye" />
                    </div>
                  </div>
                </td>
              </tr>
